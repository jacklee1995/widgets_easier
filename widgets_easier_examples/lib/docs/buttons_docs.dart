...
class ButtonDocs extends StatelessWidget {
  final int c;
  const ButtonDocs(this.c, {super.key});
  @override
  Widget build(BuildContext context) {
    return DocsWidget(
      children: [
        Write.header1('$c. 按钮'),
        Write.header2('$c.1 按钮语义'),
        ...
        const Gap(20),
        Write.header2('$c.2 轮廓按钮'),
        const Gap(20),
        Write.header3('$c.2.1 基本用法'),
        ...
        const Gap(20),
        Write.header2('$c.5 按钮尺寸'),
        Write.header3('$c.5.1 尺寸枚举'),
        ...
        const Gap(10),
        Write.header2('$c.6 文本样式'),
        Write.header3('$c.6.1 文本样式'),
        ...
        Write.header2('$c.7 按钮图标'),
        Write.header3('$c.7.1 前缀图标的使用'),
        Write.paragraph(
        ...
        Write.header3('$c.8.1 默认行为（shrink = false）'),
        Write.orderedList([
        ...
        Write.header3('$c.8.2 收缩行为（shrink = true）'),
        Write.orderedList([
        ...
        const Gap(20),
        Write.header2('$c.9 自定义颜色'),
        Write.header3('$c.9.1 自定义按钮单色'),
        Write.paragraph(
