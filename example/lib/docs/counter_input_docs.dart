...
class CounterInputDocs extends StatelessWidget {
  const CounterInputDocs({super.key});
  ...
  textColor: Colors.white,
        ...
        Write.header2('5.3 尺寸'),
        Write.header3('5.3.1 枚举尺寸'),
        Write.paragraph(
